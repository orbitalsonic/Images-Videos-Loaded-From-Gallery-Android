...
import com.orbitalsonic.imagesloadergallery.databinding.ItemMainSelectedBinding
...
class AdapterMainSelected : ListAdapter<FileItem, RecyclerView.ViewHolder>(DATA_COMPARATOR){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val binding: ItemMainSelectedBinding = DataBindingUtil.inflate(layoutInflater,R.layout.item_main_selected,parent,false)
    ...
    class GalleryLoaderViewHolder(binding:ItemMainSelectedBinding, listener: OnItemClickListener) :
